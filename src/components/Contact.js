            ...
            <div className='contact mx-10 sm:mx-14 my-4 sm:my-9'>
                ...
                <div className="mt-5 gap-3 flex flex-col">
                    ...
                    <div className="text-md sm:text-xl flex flex-col gap-2">
                        <p className="font-poppins "><span className="font-bold">Phone: </span> +91 9876543210</p>
                        <p className="font-poppins "><span className="font-bold">Email: </span> karanamsaiharshith@gmail.com</p>
                        <p className="font-poppins "><span className="font-bold">Address: </span> Hyderabad, Telangana, India</p>
                    </div>
                </div>
